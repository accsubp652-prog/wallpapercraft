...
import { Sparkles, Plus, Lock, User as UserIcon, LogOut } from 'lucide-react';
...
export default function Navbar() {
  ...
  const handleOpenUpload = () => {
    ...
    if (!user.isPremium) {
      alert('Tu cuenta pertenece al Plan Gratuito. No tienes permisos para publicar fondos.');
      return;
    }
